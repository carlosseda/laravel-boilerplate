      ...
      'inputs' => [
        'general' => [
          'noLocale' => [
            ...
            ['name' => 'gender', 'label' => 'Sexo', 'type' => 'checkbox', 'width' => 'full-width', 'options' => [
              ['value' => '1', 'label' => 'Opción 1'],
              ['value' => '2', 'label' => 'Opción 2', 'checked' => 'checked'],
              ['value' => '3', 'label' => 'Opción 3'],
            ]],
            ...
            ['name' => 'password', 'label' => 'Contraseña', 'type' => 'password', 'width' => 'half-width', 'attributes' => ['required' => true]],
            ['name' => 'range', 'label' => 'Rango', 'type' => 'range', 'width' => 'half-width', 'attributes' => ['min' => 0, 'max' => 100, 'step' => 1]],
